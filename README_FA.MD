...
## | [نسخه فارسی](https://github.com/hamijafayi-debug/MasterDnsVPN/blob/main/README_FA.MD) | [English Version](https://github.com/hamijafayi-debug/MasterDnsVPN/blob/main/README.MD) |
...
| :--- | :--- | :--- | :--- |
| ویندوز (Windows) 🪟 | `AMD64` (64-bit) | ویندوز ۱۰ و ۱۱ | [دانلود نسخه ویندوز ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Client_Windows_AMD64.zip) |
| ویندوز (Windows) 🪟 | `x86` (32-bit) | سیستم‌های قدیمی ۳۲ بیتی ویندوز | [دانلود نسخه ویندوز x86 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Client_Windows_X86.zip) |
| ویندوز (Windows) 🪟 | `ARM64` | دستگاه‌های ویندوزی مبتنی بر ARM | [دانلود نسخه ویندوز ARM64 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Client_Windows_ARM64.zip) |
| مک‌اواس (macOS) 🍎 | `ARM64` | مک‌های جدید (سری M1 / M2 / M3) | [دانلود نسخه مک (Apple Silicon) ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Client_MacOS_ARM64.zip) |
| مک‌اواس (macOS) 🍎 | `AMD64` | مک‌های اینتل | [دانلود نسخه مک اینتل ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Client_MacOS_AMD64.zip) |
| لینوکس (Linux) 🐧 | `AMD64` (64-bit) | توزیع‌های جدید (اوبونتو ۲۲.۰۴+، دبیان ۱۲+) | [دانلود نسخه لینوکس (جدید) ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Client_Linux_AMD64.zip) |
| لینوکس (Linux) 🐧 | `x86` (32-bit) | سیستم‌های قدیمی ۳۲ بیتی لینوکس | [دانلود نسخه لینوکس x86 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Client_Linux_X86.zip) |
| لینوکس (Legacy) 🐧 | `AMD64` (64-bit) | توزیع‌های قدیمی (اوبونتو ۲۰.۰۴، دبیان ۱۱) | [دانلود نسخه لینوکس (سازگاری بالا) ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Client_Linux-Legacy_AMD64.zip) |
| لینوکس (Legacy) 🐧 | `ARM64` | سیستم‌های ARM64 قدیمی‌تر که سازگاری بیشتری می‌خواهند | [دانلود نسخه لینوکس Legacy ARM64 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Client_Linux-Legacy_ARM64.zip) |
| لینوکس (ARM) 🐧 | `ARM64` | سرورهای ARM، رزبری‌پای و بردهای مشابه | [دانلود نسخه لینوکس (ARM) ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Client_Linux_ARM64.zip) |
| لینوکس (ARM) 🐧 | `ARMv7` | بردهای ARM ۳۲ بیتی و دستگاه‌های قدیمی‌تر | [دانلود نسخه لینوکس ARMv7 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Client_Linux_ARMV7.zip) |
| لینوکس (ARM) 🐧 | `ARMv6` | بردهای ARM قدیمی‌تر و سیستم‌های سبک لینوکسی | [دانلود نسخه لینوکس ARMv6 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Client_Linux_ARMV6.zip) |
| لینوکس (ARM) 🐧 | `ARMv5` | دستگاه‌های ARM خیلی قدیمی و سیستم‌های embedded | [دانلود نسخه لینوکس ARMv5 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Client_Linux_ARMV5.zip) |
| لینوکس (Linux) 🐧 | `RISCV64` | بردها و سرورهای لینوکسی مبتنی بر RISC-V | [دانلود نسخه لینوکس RISCV64 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Client_Linux_RISCV64.zip) |
| لینوکس (MIPS) 🐧 | `MIPS` | سیستم‌ها و روترهای لینوکسی MIPS با endian بزرگ | [دانلود نسخه لینوکس MIPS ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Client_Linux_MIPS.zip) |
| لینوکس (MIPS) 🐧 | `MIPSLE` | سیستم‌ها و روترهای لینوکسی MIPS با endian کوچک | [دانلود نسخه لینوکس MIPSLE ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Client_Linux_MIPSLE.zip) |
| لینوکس (MIPS) 🐧 | `MIPS64` | سیستم‌های ۶۴ بیتی MIPS با endian بزرگ | [دانلود نسخه لینوکس MIPS64 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Client_Linux_MIPS64.zip) |
| لینوکس (MIPS) 🐧 | `MIPS64LE` | سیستم‌های ۶۴ بیتی MIPS با endian کوچک | [دانلود نسخه لینوکس MIPS64LE ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Client_Linux_MIPS64LE.zip) |
| ترموکس / اندروید 📱 | `ARM64` | گوشی‌های اندرویدی جدید با Termux | [دانلود نسخه ترموکس ARM64 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Client_Termux_ARM64.zip) |
| ترموکس / اندروید 📱 | `ARMv7` | گوشی‌های قدیمی‌تر با محیط ۳۲ بیتی Termux | [دانلود نسخه ترموکس ARMv7 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Client_Termux_ARMV7.zip) |
| **اندروید (اپ گرافیکی)** 📱 | `Universal` | گوشی‌های اندروید ۷.۰ به بالا — اپ رسمی **MasterDnsPro** با رابط کاربری گرافیکی، بدون نیاز به Termux | [دانلود APK مستر دی‌ان‌اس پرو ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsPro_Android_Universal.apk) |
...
| سیستم‌عامل (OS) | پردازنده (Architecture) | مناسب برای سیستم‌های... | لینک دانلود مستقیم |
| :--- | :--- | :--- | :--- |
| ویندوز (Windows) 🪟 | `AMD64` (64-bit) | ویندوز سرور، ویندوز ۱۰ و ۱۱ | [دانلود سرور ویندوز ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Server_Windows_AMD64.zip) |
| ویندوز (Windows) 🪟 | `x86` (32-bit) | سیستم‌های قدیمی ۳۲ بیتی ویندوز | [دانلود سرور ویندوز x86 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Server_Windows_X86.zip) |
| ویندوز (Windows) 🪟 | `ARM64` | دستگاه‌های ویندوزی مبتنی بر ARM | [دانلود سرور ویندوز ARM64 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Server_Windows_ARM64.zip) |
| لینوکس (Linux) 🐧 | `AMD64` (64-bit) | سرورهای اوبونتو ۲۲.۰۴+، دبیان ۱۲+ | [دانلود سرور لینوکس (جدید) ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Server_Linux_AMD64.zip) |
| لینوکس (Linux) 🐧 | `x86` (32-bit) | سیستم‌های قدیمی ۳۲ بیتی لینوکس | [دانلود سرور لینوکس x86 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Server_Linux_X86.zip) |
| لینوکس (Legacy) 🐧 | `AMD64` (64-bit) | سرورهای قدیمی (اوبونتو ۲۰.۰۴، دبیان ۱۱) | [دانلود سرور لینوکس (سازگاری بالا) ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Server_Linux-Legacy_AMD64.zip) |
| لینوکس (Legacy) 🐧 | `ARM64` | سیستم‌های ARM64 قدیمی‌تر که سازگاری بیشتری می‌خواهند | [دانلود سرور لینوکس Legacy ARM64 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Server_Linux-Legacy_ARM64.zip) |
| لینوکس (ARM) 🐧 | `ARM64` | سرورهای ARM | [دانلود سرور لینوکس (ARM) ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Server_Linux_ARM64.zip) |
| لینوکس (ARM) 🐧 | `ARMv7` | سرورهای ARM ۳۲ بیتی و دستگاه‌های embedded | [دانلود سرور لینوکس ARMv7 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Server_Linux_ARMV7.zip) |
| لینوکس (ARM) 🐧 | `ARMv6` | بردهای ARM قدیمی‌تر و سیستم‌های سبک لینوکسی | [دانلود سرور لینوکس ARMv6 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Server_Linux_ARMV6.zip) |
| لینوکس (ARM) 🐧 | `ARMv5` | دستگاه‌های ARM خیلی قدیمی و سیستم‌های embedded | [دانلود سرور لینوکس ARMv5 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Server_Linux_ARMV5.zip) |
| لینوکس (Linux) 🐧 | `RISCV64` | بردها و سرورهای لینوکسی مبتنی بر RISC-V | [دانلود سرور لینوکس RISCV64 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Server_Linux_RISCV64.zip) |
| لینوکس (MIPS) 🐧 | `MIPS` | سیستم‌ها و روترهای لینوکسی MIPS با endian بزرگ | [دانلود سرور لینوکس MIPS ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Server_Linux_MIPS.zip) |
| لینوکس (MIPS) 🐧 | `MIPSLE` | سیستم‌ها و روترهای لینوکسی MIPS با endian کوچک | [دانلود سرور لینوکس MIPSLE ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Server_Linux_MIPSLE.zip) |
| لینوکس (MIPS) 🐧 | `MIPS64` | سیستم‌های ۶۴ بیتی MIPS با endian بزرگ | [دانلود سرور لینوکس MIPS64 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Server_Linux_MIPS64.zip) |
| لینوکس (MIPS) 🐧 | `MIPS64LE` | سیستم‌های ۶۴ بیتی MIPS با endian کوچک | [دانلود سرور لینوکس MIPS64LE ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Server_Linux_MIPS64LE.zip) |
| مک‌اواس (macOS) 🍎 | `ARM64` | مک‌های جدید (سری M1 / M2 / M3) | [دانلود سرور مک (Apple Silicon) ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Server_MacOS_ARM64.zip) |
| مک‌اواس (macOS) 🍎 | `AMD64` | مک‌های اینتل | [دانلود سرور مک اینتل ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Server_MacOS_AMD64.zip) |
| ترموکس / اندروید 📱 | `ARM64` | محیط‌های جدید اندروید / Termux | [دانلود سرور ترموکس ARM64 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Server_Termux_ARM64.zip) |
| ترموکس / اندروید 📱 | `ARMv7` | محیط‌های قدیمی‌تر اندروید / Termux ۳۲ بیتی | [دانلود سرور ترموکس ARMv7 ⬇️](https://github.com/hamijafayi-debug/MasterDnsVPN/releases/latest/download/MasterDnsVPN_Server_Termux_ARMV7.zip) |
...
docker run -d \
  ...
  -p 53:53/tcp \
  -p 53:53/udp \
  ghcr.io/hamijafayi-debug/masterdnsvpn:latest
```
...
services:
  masterdnsvpn:
    image: ghcr.io/hamijafayi-debug/masterdnsvpn:latest
    restart: unless-stopped
    environment:
...
/container add check-certificate=no dns=1.1.1.1 envlists=MasterDnsVPN hostname=MasterDnsVPN interface=MasterDnsVPN layer-dir="" mountlists=MasterDnsVPN name=MasterDnsVPN remote-image=ghcr.io/hamijafayi-debug/masterdnsvpn:latest root-dir=/containers/data/MasterDnsVPN start-on-boot=yes
```
...
### بخش ۲.۷: 🧑‍💻 اجرای مستقیم از سورس (Go)

> ⚠️ این بخش برای توسعه‌دهندگانی است که می‌خواهند سورس Go را مستقیماً اجرا کنند یا بیلد سفارشی بسازند.

#### پیش‌نیاز

- نصب **Go نسخه `1.25` یا جدیدتر** (مطابق با دایرکتیو `go` در فایل `go.mod`). دانلود رسمی: <https://go.dev/dl/>
- ابزار `git` و `make` (روی macOS/Linux معمولاً به‌صورت پیش‌فرض موجودند).

#### گام ۲.۷.۱: کلون کردن سورس و دانلود وابستگی‌ها
...
#### گام ۲.۷.۲: ساخت باینری‌ها

روش پیشنهادی — استفاده از `Makefile` (تضمین می‌کند فلگ‌های release/PGO/strip درست اعمال شوند):

```bash
# بیلد توسعه — باینری‌های قابل اجرا با debug symbols
make build
# → bin/masterdnsvpn-client و bin/masterdnsvpn-server

# بیلد release قابل حمل (روی هر CPU x86-64 اجرا می‌شود، GOAMD64=v1)
make release
# → bin/masterdnsvpn-{client,server}-release  (حدود ۸ مگابایت، stripped + trimpath)

# بیلد release مدرن (CPU های Haswell به بعد — AVX2/BMI، سریع‌تر)
make release-modern
# → bin/masterdnsvpn-{client,server}-release-v3

# بیلد release با PGO (Profile-Guided Optimization)
make pgo-collect   # ~۳۰ ثانیه: بنچ سبک برای جمع‌آوری CPU profile
make release       # بیلد بعدی به‌طور خودکار از default.pgo استفاده می‌کند
```

بدون `Makefile` (فقط دستورات خام `go`):
...
#### گام ۲.۷.۳: ساخت فایل‌های کانفیگ از روی نمونه‌ها
...
#### گام ۲.۷.۴: اجرای سرور و کلاینت

```bash
./bin/masterdnsvpn-server -config server_config.toml
./bin/masterdnsvpn-client -config client_config.toml
```

ویندوز:

```powershell
.\bin\masterdnsvpn-server.exe -config server_config.toml
.\bin\masterdnsvpn-client.exe -config client_config.toml
```

#### گام ۲.۷.۵: اجرای تست‌ها (اختیاری ولی توصیه‌شده)

برای اطمینان از سلامت بیلد قبل از deploy:

```bash
make test          # تست‌ها بدون race detector — سریع
make test-race     # تست‌ها با race detector — کندتر ولی کامل‌تر
make vet           # static analysis استاندارد Go
```

> 💡 اگر `make test-race` در محیط CI کند است، اول `make build` و `make test` کافی‌اند.
...
## 🧪 بنچ‌مارک و محافظ رگرسیون CI

این مخزن یک **محافظ رگرسیون عملکرد** خودکار دارد که از هر pull request در برابر کند شدن تصادفی hot-path محافظت می‌کند.

### نصب (یک‌بار، نیاز به scope `workflow`)
فایل workflow به‌صورت template در مسیر `scripts/benchregress/bench.yml.template` قرار دارد. برای فعال‌سازی، آن را به `.github/workflows/bench.yml` کپی و با PAT/account که `workflow` scope دارد commit کنید:
```bash
mkdir -p .github/workflows
cp scripts/benchregress/bench.yml.template .github/workflows/bench.yml
git add .github/workflows/bench.yml
git commit -m "ci: enable bench regression workflow"
git push
```
این جداسازی به این دلیل است که برخی GitHub App token‌ها مجوز ایجاد فایل workflow را ندارند.

### Workflow (پس از نصب)
- **فایل:** `.github/workflows/bench.yml` (کپی‌شده از template)
- **trigger‌ها:**
  - `pull_request` → بنچ‌مارک‌ها روی HEAD اجرا می‌شوند، با آخرین baseline مقایسه می‌شوند و یک گزارش markdown به‌صورت کامنت روی PR منتشر می‌شود. اگر هر بنچی بیشتر از threshold کند شده باشد، job فیل می‌کند.
  - `push` به `main` → پس از merge، baseline جدید تولید و به branch جداگانه `bench-baseline` پوش می‌شود.
  - `workflow_dispatch` → اجرای دستی با امکان تنظیم `threshold`، `benchtime`، `count`.
- **threshold پیش‌فرض:** **۲۰٪** برای ns/op (انتخاب‌شده برای جذب noise در runner CI — local development باید روی ≤۱۰٪ هدف بگیرد).

### اجزا
- `scripts/benchregress/run_bench.sh` — اجرای `go test -bench` روی ۱۱ پکیج کلیدی (`arq`، `basecodec`، `client`، `compression`، `dnscache`، `dnsparser`، `logger`، `security`، `streamutil`، `udpserver`، `vpnproto`).
- `scripts/benchregress/main.go` — ابزار Go بدون وابستگی که دو فایل خروجی بنچ را parse می‌کند، Δ% روی `ns/op` محاسبه می‌کند، جدول markdown می‌سازد و در صورت رگرسیون با exit code `1` خارج می‌شود.

### استفاده محلی
```bash
# گرفتن snapshot baseline روی tree تمیز
./scripts/benchregress/run_bench.sh baseline.txt 1s 1

# پس از تغییرات، دوباره اجرا کن و مقایسه کن
./scripts/benchregress/run_bench.sh current.txt 1s 1
go run ./scripts/benchregress -baseline baseline.txt -current current.txt -threshold 10 -markdown report.md
```

### استراتژی ذخیره
Baseline تاریخی در یک branch orphan با نام `bench-baseline` نگهداری می‌شود (auto-managed). تاریخچه main تمیز می‌ماند و PR‌ها همیشه با آخرین حالت merge‌شده مقایسه می‌شوند.

---

## 🔬 پوشش Fuzz و فاز مداوم (Continuous Fuzzing)

در کنار گارد رگرسیون بنچ، یک **لایه fuzz-test** هم در مخزن داریم که مسیرهای parsing و crypto را با ورودی‌های تصادفی روی هر commit آزمایش می‌کند.

### چرا فاز؟

تست‌های unit دستی، شکل *مورد انتظار* ورودی را پوشش می‌دهند. فاز همه چیزی را پوشش می‌دهد که انتظارش را نداریم — پکت‌های ناقص، هدرهای بریده، counterهای دشمنانه، بافرهای بزرگ — یعنی دقیقاً چیزی که یک مهاجم روی اینترنت عمومی می‌تواند بفرستد.

در حین استپ ۲۲ یک sweep کوتاه فاز (مجموعاً < ۶۰ ثانیه) یک **باگ DoS واقعی production** در کدک ChaCha20 پیدا کرد (`CRYPTO-PANIC-1`): یک peer از راه دور می‌توانست با ست کردن initial counter ۳۲ بیتی ChaCha20 روی `0xFFFFFFFF` باعث یک panic غیرقابل recovery داخل `golang.org/x/crypto/chacha20.(*Cipher).XORKeyStream` بشود. seed کرش‌کننده (`a465a91bc12acc82`) الان زیر `internal/security/testdata/fuzz/...` commit شده و در هر اجرای CI replay می‌شود تا همان باگ هیچ‌وقت بی‌سر و صدا برنگردد.

### Fuzz target های موجود

| پکیج | Target | چه چیزی را تست می‌کند |
|---|---|---|
| `internal/vpnproto` | `FuzzParse` | invariantهای کامل `Parse(data)`: کران طول هدر، decode فلگ‌های extension، چک integrity. |
| `internal/vpnproto` | `FuzzParseAtOffset` | نسخه offset-دار — محافظ off-by-one روی بافر کران‌دار. |
| `internal/vpnproto` | `FuzzForEachPackedControlBlock` | پیمایش کران‌دار packed control blockها؛ محافظ OOB روی payload misaligned. |
| `internal/vpnproto` | `FuzzDescribePackedControlBlocks` | مسیر debug-render؛ نباید روی بایت‌های attacker-controlled panic کند. |
| `internal/dnsparser` | `FuzzParseDNSRequestLite` | parser سبک DNS request — استخراج نام و validation label-jump. |
| `internal/dnsparser` | `FuzzParseName` | decompression نام DNS — منطقه‌ای که تاریخاً پر از CVE بوده. |
| `internal/security` | `FuzzCodecDecryptDoesNotPanic` | مسیر Decrypt cross-method (AES/ChaCha/XOR) — همان target که `CRYPTO-PANIC-1` را پیدا کرد. |
| `internal/security` | `FuzzCodecEncryptDecryptRoundTrip` | تست property: `Decrypt(Encrypt(x)) == x` برای هر ۶ روش کدک. |
| `internal/security` | `FuzzCodecDecodeStringAndDecrypt` | entry point on-wire رشته‌ای — ترکیب base64 + codec. |
| `internal/security` | `FuzzCodecDecodeAndDecrypt` | همان مسیر روی بایت خام — مرز binary و pool buffer reuse را تست می‌کند. |

هر target یک corpus seed مخصوص خودش دارد؛ کرش‌های جدید به‌صورت خودکار زیر `internal/<pkg>/testdata/fuzz/<TargetName>/<sha>` ذخیره می‌شوند و رایگان به regression seed دائمی تبدیل می‌شوند.

### اجرای فاز به‌صورت محلی

```bash
# replay همه corpus ذخیره‌شده (سریع، deterministic — بخشی از `go test`)
go test -race -count=1 ./internal/vpnproto/... ./internal/dnsparser/... ./internal/security/...

# فاز یک target مشخص برای ۳۰ ثانیه (اگر کرش پیدا کرد، seed جدید می‌نویسد)
go test -run='^$' -fuzz='^FuzzCodecDecryptDoesNotPanic$' -fuzztime=30s ./internal/security/

# لیست همه fuzz target های یک پکیج
go test -list '^Fuzz' ./internal/vpnproto/...
```

### Fuzz در CI

مشابه workflow بنچ، workflow فاز هم به‌صورت یک template ارائه می‌شود که maintainer یک بار به `.github/workflows/` کپی می‌کند (نیاز به اسکوپ `workflow` به‌صورت یک‌باره):

```bash
mkdir -p .github/workflows
cp scripts/fuzzci/fuzz.yml.template .github/workflows/fuzz.yml
git add .github/workflows/fuzz.yml && git commit -m "ci: enable fuzz workflow"
git push
```

بعد از فعال‌سازی، workflow:

- در هر push و PR کل corpus ذخیره‌شده را replay می‌کند (هر تغییر کدی که کرش شناخته‌شده‌ای را برگرداند گیر می‌افتد، مثل CRYPTO-PANIC-1).
- هر `Fuzz*` target را برای **۳۰ ثانیه** روی هر push/PR و هر شب ساعت 03:17 UTC اجرا می‌کند.
- هر ورودی کرش‌کننده جدید را به‌عنوان artifact آپلود می‌کند (`fuzz-crashes-<target>`, retention ۳۰ روز).
- هزینه: حدود ۵ دقیقه زمان runner میزبانی‌شده GitHub در هر CI run.

بودجه ۳۰ ثانیه عمداً کوتاه است — برای فاز عمیق مداوم همچنان OSS-Fuzz پیشنهاد می‌شود. این گیت در-مخزن یک tripwire است: تضمین می‌کند کرش‌های شناخته‌شده برای همیشه fix بمانند و corpus فاز به‌طور طبیعی با codebase رشد کند.
...
[Issues](https://github.com/hamijafayi-debug/MasterDnsVPN/issues)

[Pull Requests](https://github.com/hamijafayi-debug/MasterDnsVPN/pulls)
